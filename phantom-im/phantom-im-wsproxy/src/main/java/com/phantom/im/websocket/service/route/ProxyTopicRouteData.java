 ...
 */
package com.phantom.im.websocket.service.route;
...
public class ProxyTopicRouteData {
    ...
    public static class ProxyBrokerData {
        ...
        public Map<Long, List<com.phantom.im.websocket.common.Address>> getBrokerAddrs() {
            return brokerAddrs;
        }

        public void setBrokerAddrs(Map<Long, List<com.phantom.im.websocket.common.Address>> brokerAddrs) {
